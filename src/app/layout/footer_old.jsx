        ...
        <Container>
          <Row>
            <Col lg={12} md={12}>
              ...
              >
                <div
                  className={`${styles.mailContact} d-flex justify-content-between gap-3 text-white`}
                >
                  <a href="mailto:info@bitswits.co" className="text-white">
                    info@bitswits.co
                  </a>
                  <span className="text-secondary">|</span>
                  <a href="tel:+1 833 500 6007" className="text-white">
                    +1 833 500 6007
                  </a>
                </div>
                <div className={styles.linksItem}>
